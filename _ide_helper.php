 ...
 */
     ...
     */ 
        ...
        {
                        /** @var \Apiato\Core\Abstracts\Events\Dispatcher\Dispatcher $instance */
         ...
         *
         * @param callable $resolver
         * @return \Apiato\Core\Abstracts\Events\Dispatcher\Dispatcher 
         * @static 
         */ 
        ...
        public static function macro($name, $macro)
        {            //Method inherited from \Illuminate\Events\Dispatcher         
                        \Apiato\Core\Abstracts\Events\Dispatcher\Dispatcher::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {            //Method inherited from \Illuminate\Events\Dispatcher         
                        \Apiato\Core\Abstracts\Events\Dispatcher\Dispatcher::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {            //Method inherited from \Illuminate\Events\Dispatcher         
                        return \Apiato\Core\Abstracts\Events\Dispatcher\Dispatcher::hasMacro($name);
        }
                    /**
